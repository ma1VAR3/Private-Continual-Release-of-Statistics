...
def private_estimation(user_group_means, L, K, ub, lb, epsilon, num_exp, actual_mean, groupping_algo, conc_algo, config):
    ...
    if conc_algo == "coarse_mean":
        ...
        for q in quantiles:
            ...
            quantile_1 = q
            quantile_2 = 1 - q
            q1_t = private_quantile(user_group_means, quantile_1, epsilon/4, ub, lb, num_exp, factor)
            q2_t = private_quantile(user_group_means, quantile_2, epsilon/4, ub, lb, num_exp, factor)
